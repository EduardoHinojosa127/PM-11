...
class AdicionalFragmento : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view:View =
            inflater.inflate(R.layout.fragment_adicional_fragmento,container, false)
        ...
        btnOperaciones.setOnClickListener(View.OnClickListener{
            ...
            transaccion.replace(R.id.contenedor2, operaciones)
            transaccion.commit()
        })
        var btnResultado = view.findViewById<Button>(R.id.btnResultado)
        btnResultado.setOnClickListener(View.OnClickListener {
            ...
            transaccion.replace(R.id.contenedor2,resultado)
            transaccion.commit()
        })
        return view
        return view
