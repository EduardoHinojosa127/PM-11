...
class Fragmento1 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view =
            inflater.inflate(R.layout.fragment_fragmento1, container, false)
        var lblRecibido = view.findViewById<TextView>(R.id.lblRecibido)
        if(arguments!=null){
            val recibido = requireArguments().getString("texto")
